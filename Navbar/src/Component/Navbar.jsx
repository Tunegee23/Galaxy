...
const Navbar = () => {
  ...
  return (
    <div className='bg-[#9b2204]  flex justify-center items-center h-screen p-5 justify-items-center '>
      <nav className="bg-black  p-12 container  md:h-[70vh] rounded-[10px] relative top-3 ">
